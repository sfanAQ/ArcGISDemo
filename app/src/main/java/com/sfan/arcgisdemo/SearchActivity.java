...
public class SearchActivity extends AppCompatActivity {
    ...
    private void displaySearchResult(GeocodeResult geocodedLocation) {
        ...
        Graphic mapMarker = new Graphic(geocodedLocation.getDisplayLocation(), geocodedLocation.getAttributes(), new SimpleMarkerSymbol(SimpleMarkerSymbol.Style.SQUARE, Color.rgb(255, 0, 0), 12.0f));
